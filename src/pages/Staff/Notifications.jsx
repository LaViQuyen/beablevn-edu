...
const Notifications = () => {
                            ...
                            <div 
                                ...
                                {noti.attachmentUrl && (
                                    ...
                                    >
                                        ...
                                        Mở file đính kèm: {noti.attachmentName}
                                    </a>
                                )}
                            </div>
                        )}
    ...
    return (
        <div className="space-y-8 animate-fade-in-up pb-10 mt-16 md:mt-0">
            <style>{`
                .ql-editor ul, .quill-content ul { list-style-type: disc !important; padding-left: 1.5rem !important; margin-bottom: 0.5rem !important; }
                .ql-editor ol, .quill-content ol { list-style-type: decimal !important; padding-left: 1.5rem !important; margin-bottom: 0.5rem !important; }
                .ql-editor li, .quill-content li { padding-left: 0.25rem !important; margin-bottom: 0.25rem !important; }
            `}</style>
                    ...
                    <div className="animate-fade-in">
                        ...
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full p-2 border border-slate-200 rounded-lg outline-none text-sm bg-slate-50 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors cursor-pointer"
                            />
                        </div>
                        <div className="mb-6">
