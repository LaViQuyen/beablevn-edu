  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 sm:p-12 max-w-md w-full text-center">
        ...
        {/* Icon la bàn nhỏ */}
        <div className="mx-auto my-5 w-14 h-14 rounded-full bg-primary-light flex items-center justify-center">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center gap-2 mt-6 px-6 py-3 rounded-xl bg-primary text-white text-sm font-bold hover:bg-primary-hover transition-all active:scale-[0.98] shadow-sm"
        >
